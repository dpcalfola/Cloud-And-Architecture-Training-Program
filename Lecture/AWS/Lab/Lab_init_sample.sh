...
wget https://us-west-2-tcprod.s3.us-west-2.amazonaws.com/courses/ILT-TF-200-ARCHIT/v7.5.1.prod-95cb7f04/lab-4-HA/scripts/inventory-app.zip
...
un="dbadmin"
pw="lab-password"
ep="inventory-cluster.cluster-cyxujznscv2g.us-west-2.rds.amazonaws.com"
db="inventory"
